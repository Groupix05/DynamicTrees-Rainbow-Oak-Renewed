package groupix05.dtrainbow_oaks;
...
@Mod(DynamicTreesRainbowOaks.MOD_ID)
public final class DynamicTreesRainbowOaks {

    public static final String MOD_ID = "dtrainbow_oaks";

    public DynamicTreesRainbowOaks() {
